...
from blueprints.mt_settings import mt_settings_bp  # Multi-tenant per-user settings
...
def create_app():
    ...
    app.register_blueprint(mt_settings_bp)  # Multi-tenant per-user broker settings
